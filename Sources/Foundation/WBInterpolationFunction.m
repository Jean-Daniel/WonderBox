...
- (id)initWithCallBack:(const WBInterpolationCallBack *)callback {
  return [[_WBInterpolationFunctionCB alloc] initWithCallBack:callback];
}

- (id)initWithControlPoints:(CGFloat)c1x :(CGFloat)c1y :(CGFloat)c2x :(CGFloat)c2y {
  return [[_WBInterpolationFunctionBezier alloc] initWithControlPoints:c1x :c1y :c2x :c2y];
}

- (id)initWithControlPoints:(CGFloat)c1x :(CGFloat)c1y :(CGFloat)c2x :(CGFloat)c2y length:(CGFloat)lengthHint {
  return [[_WBInterpolationFunctionBezier alloc] initWithControlPoints:c1x :c1y :c2x :c2y length:lengthHint];
}
