/*
 *  WBAsynchronousKeyValueLoading.h.h
 *  WonderBox
 *
...
typedef NS_ENUM(NSInteger, WBKeyValueStatus) {
	WBKeyValueStatusUnknown,
	WBKeyValueStatusLoading,
	WBKeyValueStatusLoaded,
	WBKeyValueStatusFailed,
	WBKeyValueStatusCancelled
};

WB_OBJC_EXPORT
@protocol WBAsynchronousKeyValueLoading <NSObject>
